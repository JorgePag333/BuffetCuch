        ...
        <div class="container">
            <div class="row">
                ...
                <?php 
                  ...
                  $consultaC=ejecutarSQL::consultar("SELECT * FROM subproductos WHERE CodigoProd=$CodigoProducto");
                if(mysqli_num_rows($consultaC)>=1){
                    $mix=mysqli_fetch_array($consultaC, MYSQLI_ASSOC);
                    echo '
                    <script>
                    window.location = "producto2.php?categ='.$mix['CodigoProd'].'";
                    </script>
                    ';
                                } else{
