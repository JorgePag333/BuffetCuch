...
$verificar=ejecutarSQL::consultar("SELECT * FROM subcategorias WHERE NumCat='".$codeCateg."'");
if(mysqli_num_rows($verificar)<=0){
    if(consultasSQL::InsertSQL("subcategorias", "NombreCat, CodigoCat", "'$nameCateg','$descripCateg'")){
        echo '<script>
            swal({
