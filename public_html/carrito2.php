                 ...
                 <div class="col-xs-12">
                    <?php
                        ...
                        if(!empty($_SESSION['carro'])){
                            $suma = 0;
                            $sumaA = 0;
                            echo '<table class="table table-bordered table-hover"><thead><tr class="bg-success"><th>Nombre</th><th>Precio</th><th>Cantidad</th><th>Subtotal</th></tr></thead>';
                            foreach($_SESSION['carro'] as $codeProd){
                                ...
                                while($fila = mysqli_fetch_array($consulta, MYSQLI_ASSOC)) {
                                    ...
                                    $titles=$fila['NombreProd'];
                                    $cant=$codeProd['cantidad'];
                                        echo "<tbody>
                                            <tr>
