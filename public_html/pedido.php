    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
              <h1>PEDIDOS <small class="tittles-pages-logo">Buffet del C:U.Ch. Online</small></h1>
            </div>
                      ...
                      <div class="container-fluid">
                        <div class="row">
                          <div class="col-xs-10 col-xs-offset-1">
                            ...
                            <p class="text-center"><button ><a target="_blank" href="Mp.php">Realice su pago por:<img class="img-responsive center-all-contens" src="assets/img/mplogo.png"></img></a></button></p>
                             <br>
                             <p class="text-center">  <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal" data-target="#PagoModalTran">Transaccion Bancaria</button></p>
                                ...
                                <tbody>
                                    ...
                                    ?> 
                                        <tr>
                                            ...
                                            <td>
                                              <?php
                                                $consu=ejecutarSQL::consultar("SELECT * FROM detalle WHERE NumPedido='".$rw['NumPedido']."'");
                                                foreach($consu as $my){
                                                  echo $my['Detalles'];
                                                  echo '<br>';
                                                }
                                           ...
                                           if( $rw['Adjunto']=="Sin archivo adjunto" ){
                                                echo $rw['Adjunto'];
                                           }else{
                                            ...
                                            ?></td>
                                            <td><a href="../report/remito.php?id=<?php echo $rw['NIT'];  ?>&np=<?php echo $rw['NumPedido']?>" class="btn btn-raised btn-xs btn-primary btn-block" target="_blank">Descargar Remito</a>
                                            </td>
                                        </tr>
      ...
      <div class="modal-dialog" role="document">
        <form class="modal-content FormCatElec" action="process/confirmcompra.php" method="POST" role="form" data-form="save">
          <div class="modal-header">
            ...
            <h4 class="modal-title" id="myModalLabel">Pagar por transaccion bancaria</h4>
          </div>
          <div class="modal-body">
            <?php
              $consult1=ejecutarSQL::consultar("SELECT * FROM cuentabanco");
              if(mysqli_num_rows($consult1)>=0){
