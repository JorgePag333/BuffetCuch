       ...
       <br>
        <div class="container">
            <div class="page-header">
              <h1>Ventas <small class="tittles-pages-logo">Mostrador</small></h1>
            </div>
            <?php
              ...
              <div class="row">
                ...
                ?>
                    <div class="col-xs-12 col-sm-6 col-md-4">
                         <div class="thumbnail tarjeta2" style=" background-color: rgba(186, 188, 171, .87);">
                           <img  class="papi1" src="./assets/img-products/<?php if($prod['Imagen']!="" && is_file("./assets/img-products/".$prod['Imagen'])){ echo $prod['Imagen']; }else{ echo "default.png"; } ?>
                           ">
                           <div class="texto">
