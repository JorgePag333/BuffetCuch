	...
	<div class="row">
        <div class="col-xs-12">
            ...
            <div class="panel panel-info">
                <div class="panel-heading text-center"><h4>Productos Adicionales</h4></div>
                    ...
                    <table class="table table-striped table-hover">
                        <thead class="">
                            <tr>
                                ...
                                <th class="text-center">Precio Adicional</th>
                        ...
                        <tbody>
                            <?php
								...
								$categorias=mysqli_query($mysqli,"SELECT SQL_CALC_FOUND_ROWS * FROM adicionales LIMIT $inicio, $regpagina");
                            ...
                            <tr>
	                        	...
	                        	<td class="text-center"><?php echo $cate['indi']; ?></td>
                                ...
                                <td class="text-center"><?php echo $cate['precioAd']; ?></td>
	                        	<td class="text-center">
	                        		<a href="configAdmin.php?view=adicionalesinfo&code=<?php echo $cate['indi']; ?>" class="btn btn-raised btn-xs btn-success">Actualizar</a>
	                        	</td>
	                        	<td class="text-center">
	                        		<form action="process/delAdicional.php" method="POST" class="FormCatElec" data-form="delete">
	                        			<input type="hidden" name="categ-code" value="<?php echo $cate['indi']; ?>">
                ...
                <div class="text-center">
                  <ul class="pagination">
                    ...
                    <?php else: ?>
                        <li>
                            <a href="configAdmin.php?view=adicionaleslist&pag=<?php echo $pagina-1; ?>">
                                <span aria-hidden="true">&laquo;</span>
                            </a>
                        </li>
                    <?php endif; ?>
                    ...
                    <?php
                        for($i=1; $i <= $numeropaginas; $i++ ){
                            if($pagina == $i){
                                echo '<li class="active"><a href="configAdmin.php?view=adicionaleslist&pag='.$i.'">'.$i.'</a></li>';
                            }else{
                                echo '<li><a href="configAdmin.php?view=adicionaleslist&pag='.$i.'">'.$i.'</a></li>';
                            }
                        }
                    ?>
