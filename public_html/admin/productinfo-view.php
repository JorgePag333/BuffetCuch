                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group">
                                ...
                                <select class="form-control" name="prod-Subcategoria">
                                    <?php
                                        $sub=ejecutarSQL::consultar("SELECT * FROM subcategorias");
                                        while($catec=mysqli_fetch_array($sub, MYSQLI_ASSOC)){
                                        	if($prod['subCat']==$catec['NumCat']){

                                            	echo '<option selected="" value="'.$catec['NumCat'].'">'.$catec['NombreCat'].' (Actual)</option>';
                                        	}else{
