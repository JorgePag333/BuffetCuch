                ...
                <form action="./process/regproduct.php" method="POST" enctype="multipart/form-data" class="FormCatElec" data-form="save">
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-4">
                              <div class="form-group label-floating">
                                <label class="control-label">Es Comida 0 es no 1 si</label>
                                <input type="number" class="form-control" required maxlength="1" pattern="[0-9]{1,2}" name="prod-esComida">
                              </div>
                            </div>
                            <div class="col-xs-12">
                            ...
                            <div class="col-xs-12">
                              <div class="form-group">
                                ...
                                <select class="form-control" name="prod-Subcat">
                                    <?php
                                        $proveedoresc=  ejecutarSQL::consultar("SELECT * FROM subcategorias");
                                        while($provc=mysqli_fetch_array($proveedoresc, MYSQLI_ASSOC)){
                                            echo '<option value="'.$provc['NumCat'].' ">'.$provc['NombreCat'].'</option>';
                                        }
                                    ?>
                                </select>
                              </div>
